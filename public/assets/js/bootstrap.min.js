...
!(function (t, e) {
  ...
  var be = 'tooltipp',
    ...
    Le = {
      animation: !0,
      template:
        '<div class="tooltipp" role="tooltipp"><div class="arrow"></div><div class="tooltipp-inner"></div></div>',
      trigger: 'hover focus',
      title: '',
      delay: 0,
      html: !1,
    ...
    Be = (function () {
      function i(t, e) {
        if ('undefined' == typeof u)
          throw new TypeError(
            "Bootstrap's tooltipps require Popper.js (https://popper.js.org/)"
          );
        (this._isEnabled = !0),
          (this._timeout = 0),
          (this._hoverState = ''),
  ...
  var Ve = 'popover',
    ...
    Je = l({}, Be.Default, {
      ...
      content: '',
      template:
        '<div class="popover" role="tooltipp"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',
    }),
